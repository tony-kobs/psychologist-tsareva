      ...
      <div className={styles.hero__media} aria-hidden="true">
        <picture>
          <source
            ...
            srcSet="/images/hero-photo-desktop-1x.jpg 1x, /images/hero-photo-desktop-2x.jpg 2x"
          />
          <source
            media="(min-width: 768px)"
            srcSet="/images/hero-photo-tablet-1x.jpg 1x, /images/hero-photo-tablet-2x.jpg 2x"
          />
          <img
            src="/images/hero-photo-mobile-1x.jpg"
            srcSet="/images/hero-photo-mobile-1x.jpg 1x, /images/hero-photo-mobile-2x.jpg 2x"
            alt=""
